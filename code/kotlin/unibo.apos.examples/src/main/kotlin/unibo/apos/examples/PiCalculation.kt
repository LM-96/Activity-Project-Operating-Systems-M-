...
fun repeatedCalculation(type : CalculationType, repetitions : Int,
                        workers : Int, onCalculation: (Int, PiCalculation) -> Unit = {_, _ -> }) : Array<PiCalculation> {
...
fun main() {
    ...
    val onSharedMemorySelection = { _ : MenuEntry ->
        ...
        val calculations = repeatedCalculation(CalculationType.SHARED_MEMORY,
    ...
    val onMessagesExchangeSelection = { _ : MenuEntry ->
        ...
        val calculations = repeatedCalculation(CalculationType.MESSAGES_EXCHANGE,
            repetition, workers, printCalculation)
        printAvg(calculations)
    }
